...
namespace DrivingExamBackend.Controllers
{
    ...
    public class ModulesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateModule([FromBody] NewModuleCmd cmd, [FromQuery] string password)
        {
            if (password != "admin") return Problem("Invalid password", statusCode: 401);
