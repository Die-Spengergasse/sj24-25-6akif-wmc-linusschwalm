...
namespace DrivingExamBackend.Controllers
{
    ...
    public class QuestionsController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<QuestionDto>>> GetExamQuestions([FromRoute] Guid moduleGuid, [FromQuery] int count)
        {
            var questions = await _db.Questions
            ...
            if (!questions.Any())
                return NotFound("Keine passenden Fragen gefunden.");
